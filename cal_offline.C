...
void cal_offline(const string& input_str)
{
 ...
 //   oss << std::put_time(&tm, "%Y%m%d_%H%M%S");
    ...
    {
        // Input file
        //filename = "/u/land/tobias_jenegger/unpacked_s455_data/s455_03_273_0012_unpacked.root";
	filename = string("/scratch8/ge37liw/workingspace/exp_s455/data/unpacked/s455_03_273_") + input_str + string("_unpacked.root");



        //TString outputpath = "/path/to/your/disk/";
        // outputFilename = outputpath + "s" + cExpId + "_cal_data_offline_" + oss.str() + ".root";
        //outputFilename = "cal_data_main0273_all_2hitsmwpc_68_12CORR.root";
	//outputFilename = "/u/land/tobias_jenegger/calibrated_s455_data/test_12.root";
	outputFilename = string("/scratch8/ge37liw/workingspace/exp_s455/data/calibrated/with_mw1/s455_03_273_") + input_str +   string("_calibrated.root");
    ...
    Bool_t fSci = true;//true!      // Start: Plastic scintillator for ToF
    ...
    // --- Traking ----------------------------------------------------------------------
    Bool_t fTracking = false;//true!!! // Tracking of fragments inside GLAD and before GLAD

    // Calibration files for SOFIA ----------------------------------------------
    // TString sofiacalfilename = sofiacaldir + "CalibParam.par";
    TString sofiacalfilename = "/scratch8/ge37liw/workingspace/exp_s455/R3BRoot/sofia/macros/s455Up2p/parameters/CalibParam.par";
    //TString sofiacalfilename = "/u/land/antiagg/R3BRoot/sofia/macros/s455Up2p/parameters/CalibParamWithoutPedestals.par";
    sofiacalfilename.ReplaceAll("//", "/");
    // Parameters for CALIFA mapping  -------------------------------------------
   // TString califadir = dir + "/macros/r3b/unpack/s455/califa/parameters/";
    TString califamapfilename = "/scratch8/ge37liw/workingspace/exp_s455/data/parameters/Califa_Mapping_3March2021.par";
    califamapfilename.ReplaceAll("//", "/");
    // Parameters for CALIFA calibration in keV  --------------------------------
    TString califacalfilename = "/scratch8/ge37liw/workingspace/exp_s455/data/parameters/Califa_CalPar_4March2021.par";
